...
#Correcting the data by dropping features
...
#Converting a categorial feature
...
#We can now remove the AgeBand attribute
...
#We now need to complete the Embarked attribute
